...
int path_cost (float nodes_array[][3]){
  int cost = 0;
...
void should_accept (float nodes_array[][3], float temp){ //generates 2otp from current, compares them and picks the optimal one (at the end, input array will contain optimal). Also updates the best.
...
int main () {
  ...
  float temp_change = 0.9999; //alpha
  float temp_min = 0.00000001;
...
////////////////////////////////// ANNEALING //////////////////////////////////
  ...
  float best[nodes_number][3];
  int shuffled_cost;
  int j = 0;

  for (float i = temperature; i > temp_min; i = temp_change * i){
